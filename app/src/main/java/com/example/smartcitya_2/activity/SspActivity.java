...
/**
 * @Login Name win10
 * @Create by 张瀛煜 on 2020/10/19 at 10:50
 */
public class SspActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initView();
        title.setText("随手拍");
        title1.setText("我的随手拍");
        title1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SspActivity.this, WdlyActivity.class);
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Ssp.add(new LY(choose, etTitle.getText().toString()
                ...
                Util.showToast("提交成功", SspActivity.this);
            }
        });
