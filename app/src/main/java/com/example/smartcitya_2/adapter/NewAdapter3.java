 ...
 */
public class NewAdapter3 extends ArrayAdapter<NewList> {
    public NewAdapter3(@NonNull Context context, @NonNull List<NewList> objects) {
                ...
                .setVolleyLo(new VolleyLo() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        NewDetails newDetails = new Gson().fromJson(jsonObject.optJSONArray(Util.Rows).optJSONObject(0).toString()
                                , NewDetails.class);
                        itemMsg.setText("观看人数：" + newDetails.getAudienceCount());
